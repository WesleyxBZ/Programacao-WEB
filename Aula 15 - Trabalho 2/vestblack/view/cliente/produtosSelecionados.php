  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link disabled" href="index.php">Selecionar</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="produtosSelecionados.php">Produtos selecionados</a>
          </li>
          <div class="btn-group">
            <button class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"> <?php if(isset($_SESSION['nome'])){ echo $_SESSION['nome']; } ?> </button>
          ...
          <table class="table">
            ...
            <tbody>
              <?php
                ...
                $resultado = mostrarProdutosSelecionados($codigoUsuario);
                $soma=0;
                ...
                if($resultado){
                  while($linha = mysqli_fetch_assoc($resultado)){
                    ...
                    echo "<tr>
                            ...
                            <td>R$" .$preco. "0</td>
                            <td>
                              <a class='btn btn-secondary' href='../../control/controleVenda.php?opcao=retirarSelecao&codigoProd=$codigoProduto&codigoUser=$codigoUsuario'>Retirar selecão</a>
                            </td>
                          </tr>";
                    ...
                    echo "<tr>
                            <td></td>
                            <td></td>
                            <td class='text-right'><b><b>Total de:<b><b></td>
                            <td><b><b>R$" .$soma. "0<b><b></td>
                          </tr>";
                    }
              ?>
            </tbody>
