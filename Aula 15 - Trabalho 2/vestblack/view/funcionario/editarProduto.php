  ...
  <div class="py-5" style="background-image: url('../../img/3132.jpg');">
    <div class="container">
      <?php
        ...
        $resultado = mostrarProdutoAlterar($codigoProduto);
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card text-white p-5">
            <div class="card-body">
              <h1 class="mb-4 text-dark">Editar Produto</h1>
              <form method="post" action="../../control/controleProduto.php">
                <div class="form-group">
                  <label class="text-dark" for="nome">Nome</label>
                  <input type="text" id="nome" name="nome" value="<?php echo $nome; ?>" class="form-control" placeholder="digite o nome"> </div>
                <div class="form-group">
                  <label class="text-dark" for="tamanho">Tamanho</label>
                  <input type="text" placeholder="digite o tamanho" id="tamanho" name="tamanho" value="<?php echo $tamanho; ?>" class="form-control"> </div>
                <div class="form-group">
                  <label class="text-dark" for="preco">Preço</label>
                  <input type="text" class="form-control" placeholder="digite o preço do produto" id="preco" name="preco" value="<?php echo $preco; ?>"> </div>
                  <div class="form-group">
                  <label class="text-dark" for="preco">Código de barras</label>
                  <input type="text" class="form-control codigoBarras" placeholder="digite o codigo de barras" id="codigoBarras" name="codigoBarras" value="<?php echo $codigoBarras; ?>"> 
                  <input type="hidden" name="codigoProduto" value="<?php echo $codigoProduto; ?>"> </div>
                <button type="submit" name="opcao" value="alterarProduto" class="btn btn-secondary">Alterar</button>
                <button type="submit" class="btn btn-danger m-1" name="opcao" value="excluirProduto">Excluir</button>
                <a class="btn btn-warning" href="VisualizarProdutos.php">Cancelar</a>
              </form>
            </div>
          </div>
        </div>
