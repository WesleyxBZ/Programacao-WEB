    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link desable" href="cadastro.php">Cadastrar</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="align-self-center col-md-6 text-white">
          ...
          <h3 class="text-muted">
            <b>Falta pouco, agora faça seu login. </b>
          </h3>
        </div>
        <div class="col-md-6">
          <div class="card">
            <div class="card-body p-5">
              ...
              <form action="../control/controleUsuario.php" method="post">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="digite seu nome" id="nome" name="nome"> </div>
                <div class="form-group">
                  <label for="senha">Senha</label>
                  <input class="form-control" placeholder="digite sua senha" id="senha" type="password" name="senha"> </div>
                  <p class="lead">Não tem uma conta?
                    <a href="cadastro.php">Fazer cadastro</a>
                  </p>
                <button type="submit" name="opcao" value="login" class="btn btn-secondary">Login</button>
              </form>
            </div>
          </div>
        </div>
