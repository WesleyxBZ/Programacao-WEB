        ...
        <div class="col-md-12">
          <form class="" method="post" action="controleEstoque.php">
            <div class="form-group"> <label for="descricao">Descrição</label>
              <input type="text" class="form-control" placeholder="Digite o nome do produto" id="descricao" name="descricao"> <small class="form-text text-muted"></small> </div>
            ...
            <button type="submit" class="btn btn-primary mr-auto" name="opcao" value="Cadastrar">Cadastrar</button>
            <a class="btn btn-secondary m-1" href="index.php">Cancelar</a>
          </form>
        </div>
      </div>
    </div>
